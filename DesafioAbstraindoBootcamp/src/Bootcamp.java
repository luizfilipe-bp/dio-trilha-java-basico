...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((desenvolvedoresInscritos == null) ? 0 : desenvolvedoresInscritos.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (dataFinal == null) {
            ...
            return false;
        if (desenvolvedoresInscritos == null) {
            if (other.desenvolvedoresInscritos != null)
                return false;
        } else if (!desenvolvedoresInscritos.equals(other.desenvolvedoresInscritos))
            return false;
        if (conteudos == null) {
